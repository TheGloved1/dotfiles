...
hl.curve("rubber", { type = "spring", mass = 0.6, stiffness = 70, dampening = 10 })
...
hl.animation({ leaf = "layers", enabled = true, speed = 2, spring = "rubber" })
...
hl.animation({ leaf = "border", enabled = true, speed = 2, spring = "rubber" })
hl.animation({ leaf = "borderangle", enabled = true, speed = 2, spring = "rubber" })
