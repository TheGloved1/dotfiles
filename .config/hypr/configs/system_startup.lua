...
-- ==================================================
-- System startup commands (from configs/Startup_Apps.conf)
...
-- Cursor refresh
exec_once("sh -c 'sleep 0.3; hyprctl setcursor \"${HYPRCURSOR_THEME:-Bibata-Catppuccin-Mocha-Lavender}\" \"${HYPRCURSOR_SIZE:-24}\"'")
