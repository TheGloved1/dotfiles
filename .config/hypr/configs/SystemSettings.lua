...
-- TODO: manual review — unknown section 'monocle {' on line 51
...
-- 4-finger gesture for overview toggled via exec is not supported in the hl.gesture Lua API
-- (hl.gesture only supports "workspace" actions, not exec commands)
hl.gesture({
    fingers = 4,
    direction = "down",
    action = "float",
...
hl.config({
    ...
    misc = {
        ...
        vrr = 1, -- Disabling by default causes MPV to black screen when maximixes 
