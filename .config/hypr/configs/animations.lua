...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 5, bezier = "smooth" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 5, bezier = "smooth" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "smooth", style = "slidefadevert 20%" })
