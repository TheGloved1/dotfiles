...
items=(
  ...
  "Edit Niri Noctalia Binds|$niri_dir/noctalia/binds.kdl"
  "Edit Niri Noctalia Autostart|$niri_dir/noctalia/autostart.kdl"
  "Edit Niri Core|$niri_dir/core"
  "Edit Niri DMS|$niri_dir/dms"
